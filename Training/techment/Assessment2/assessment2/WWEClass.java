...
public class WWEClass
{
	public static void main(String[] args) {
		// TODO Auto-generated method stub
			Wrestler wrestler1 = new Wrestler("Aniket", "Dubey", 120);
			Wrestler wrestler2 = new Wrestler("Ravi", "Shastri", 150);
			Wrestler wrestler3 = new Wrestler("Sajjan", "Mishra", 280);
			Wrestler wrestler4 = new Wrestler("Akash", "Pandey", 330);
			Wrestler wrestler5 = new Wrestler("Rohit", "Kumar", 290);
